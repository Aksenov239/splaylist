...
do
    ...
    do
        ...
        do
            ...
            LD_PRELOAD=../lib/jemalloc/lib/libjemalloc.so numactl --interleave=all ./bin/bench_skiplist_locks.alloc_new.reclaim_none.pool_none.out prefill $prefill secs $s presecs 0 zipf 1 cops $cops threads $threads >> results_zipf/skiplist_locks
